...
namespace StandupAggregation.Web.Helpers
{
    public static class QueryableCaseExtensions
    {
    ...
    {
        private readonly Func<Expression, Expression> createReplacement;
        private readonly Func<Expression, bool> match;
